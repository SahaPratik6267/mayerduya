...
$result = mysqli_query($mysqli, "SELECT * FROM clientinfo where branch_assigned=2 order by name asc");
...
?>
    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            ...
            <?php
            $wholtotaldue = 0;
            $resulto = mysqli_query($mysqli, "SELECT * FROM clientinfo where branch_assigned=2 ");
                    ...
                    <div class="widget-content widget-content-area br-6">
                        ...
                        <div class="table-responsive mb-4 mt-4">
                            <div id="table-container" style="display: none;">
                                <table class="table table-hover" id="maintable" width='100%' border=0>
                                    <thead>
                                    <tr>
