...
<body>
    <div class="invoice-box">
		...
		" action="test.php" method="post" name="my-form">
...
<option value="SHIP">SHIP</option>
                                ...
                                <td> Lot: <input type="text" name="lot_no" value="<?php echo $lot; ?>">
                            </td>
                        </tr>
                    </table>
                </td>
...
Phone: 01758425235 </div>
				...
				echo "<select ID='mySelect' onchange='this.form.submit()' name='client_id' data-placeholder='Choose a Client...' class='chosen-select' tabindex='2'>";
...
echo "Address : ";echo $sname;
				...
				<td>Date
				<input type="date" name="date" value="<?php echo $date; ?>"></td>
                        </tr>
                    </table>
                </td>
            </tr>
